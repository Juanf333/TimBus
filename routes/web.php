...
Route::get('/', function () {
    $empresaswelcome = transportes::join("rutas","transportes.id_ruta", "=", "rutas.id")  //simplePaginate
    // ->where('')
    //  "id_sitio",$site->id
    ...
    return view('welcome', compact('empresaswelcome'));
})->name('welcome');
...
// Route::post('/flashAlert', [CartController::class,'alertaWelcomeIniciarSesion'])->name('alertaWelcomeIniciarSesion');
